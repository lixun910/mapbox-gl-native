...
final class NativeMapView {
  ...
  public void addImages(@NonNull HashMap<String, Bitmap> bitmapHashMap) {
    ...
    new BitmapConverterTask(this).execute(bitmapHashMap);
  }
  ...
  private static class BitmapConverterTask extends AsyncTask<HashMap<String, Bitmap>, Void, List<Image>> {

    private NativeMapView nativeMapView;

    BitmapConverterTask(NativeMapView nativeMapView) {
